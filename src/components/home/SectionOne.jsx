...
export default function SectionOne() {
  ...
  return (
    <div className="flex flex-row w-full bg-emerald-400 text-white">
      <div className="w-1/2 text-center">
        <h1 className="m-4 leading-[3rem]">
          Bienvenue sur EcoVibe Votre portail vers un avenir énergétique durable
        </h1>
        <p className="text-blue-500 text-wrap text-2xl font-medium leading-[3rem]">
          Bienvenue sur EcoVibe Votre portail vers un avenir énergétique durable
        </p>
      ...
      <div className="w-1/2 flex justify-center items-center space-x-4 overflow-hidden relative">
